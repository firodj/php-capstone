...
0x100b:	add		byte ptr [di], al // insn-ID: 8, insn-mnem: add
bytes:	0x00 0x05
	size: 2
	Implicit registers modified: flags
	opcode: 0x00
...
0x100d:	and		ax, word ptr [bx + di] // insn-ID: 25, insn-mnem: and
bytes:	0x23 0x01
	size: 2
	Implicit registers modified: flags
	opcode: 0x23
...
0x100f:	add		byte ptr [bx + si], al // insn-ID: 8, insn-mnem: add
bytes:	0x00 0x00
	size: 2
	Implicit registers modified: flags
	opcode: 0x00
...
0x1011:	mov		ax, word ptr ss:[si + 0x2391] // insn-ID: 449, insn-mnem: mov
...
0x1016:	add		word ptr [bx + si], ax // insn-ID: 8, insn-mnem: add
bytes:	0x01 0x00
	size: 2
	Implicit registers modified: flags
	opcode: 0x01
...
0x1018:	add		byte ptr [bx + di - 0x73], al // insn-ID: 8, insn-mnem: add
...
0x101b:	test		byte ptr [bx + di], bh // insn-ID: 700, insn-mnem: test
bytes:	0x84 0x39
	size: 2
	Implicit registers modified: flags
	opcode: 0x84
...
0x101d:	mov		word ptr [bx], sp // insn-ID: 449, insn-mnem: mov
...
0x1020:	add		byte ptr [di - 0x7679], cl // insn-ID: 8, insn-mnem: add
...
0x1024:	add		byte ptr [eax], al // insn-ID: 8, insn-mnem: add
...
0x1027:	mov		ah, 0xc6 // insn-ID: 449, insn-mnem: mov
bytes:	0xb4 0xc6
	size: 2
	opcode: 0xb4
	rex: 0x0
...
0x100c:	addl		$0x123, %eax // insn-ID: 8, insn-mnem: addl
...
0x1011:	movl		%ss:0x123(%ecx, %edx, 4), %eax // insn-ID: 449, insn-mnem: movl
...
0x1019:	incl		%ecx // insn-ID: 215, insn-mnem: incl
bytes:	0x41
	size: 1
	Implicit registers modified: eflags
	This instruction belongs to groups: not64bitmode
...
0x101a:	leal		0x6789(%ecx, %edi), %eax // insn-ID: 322, insn-mnem: leal
...
0x1021:	leal		0x6789(%edi), %eax // insn-ID: 322, insn-mnem: leal
...
0x1027:	movb		$0xc6, %ah // insn-ID: 449, insn-mnem: movb
bytes:	0xb4 0xc6
	size: 2
	opcode: 0xb4
	rex: 0x0
...
0x100c:	add		eax, 0x123 // insn-ID: 8, insn-mnem: add
bytes:	0x05 0x23 0x01 0x00 0x00
	size: 5
	Implicit registers modified: eflags
	opcode: 0x05
...
0x1011:	mov		eax, dword ptr ss:[ecx + edx*4 + 0x123] // insn-ID: 449, insn-mnem: mov
bytes:	0x36 0x8b 0x84 0x91 0x23 0x01 0x00 0x00
	size: 8
	prefix: ss
	opcode: 0x8b
...
0x1019:	inc		ecx // insn-ID: 215, insn-mnem: inc
bytes:	0x41
	size: 1
	Implicit registers modified: eflags
	This instruction belongs to groups: not64bitmode
...
0x101a:	lea		eax, [ecx + edi + 0x6789] // insn-ID: 322, insn-mnem: lea
bytes:	0x8d 0x84 0x39 0x89 0x67 0x00 0x00
	size: 7
	This instruction belongs to groups: not64bitmode
	opcode: 0x8d
...
0x1021:	lea		eax, [edi + 0x6789] // insn-ID: 322, insn-mnem: lea
bytes:	0x8d 0x87 0x89 0x67 0x00 0x00
	size: 6
	This instruction belongs to groups: not64bitmode
	opcode: 0x8d
...
0x1008:	vpcomtruew		xmm4, xmm3, xmm2 // insn-ID: 1034, insn-mnem: vpcomtruew
